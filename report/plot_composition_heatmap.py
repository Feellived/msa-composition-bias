...
사용:
  python report/plot_composition_heatmap.py                      # 기본 경로
  python report/plot_composition_heatmap.py --results pipeline/results --outdir report/figures
  python report/plot_composition_heatmap.py --thr 0.4 --max-comp 6
