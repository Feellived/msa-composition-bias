...
> ⚠️ **시점 문서 (2026-07-20 v1).** 이 계획안의 중심 가설이던 "MSA 깊이를 낮추면 정답 자세가
> 되살아난다"는 이후 순열검정에서 **기각**됐다. 확정된 결론은 최종 보고서(`report/report.md`)와
> Notion 「인수인계서 Ⅱ」에 있다. 이 문서는 설계 의도와 사전 등록 기록으로만 읽을 것.
