...
stdlib only (DockQ env 아니어도·로컬에서도 실행됨). pose_features.py 산출 CSV를 읽어:
...
사용:
  python phase0_check.py                         # results/pose_features.csv
  python phase0_check.py --csv 다른경로.csv
"""
...
def main():
    ...
    print("\n다음 → phase1_rerank.py : 무학습 재랭커 make-or-break (ipTM vs 배포가능 기하 피처).")
