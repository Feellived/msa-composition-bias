...
사용:
  python -u collect_data.py                      # 무엇을 가져올지만 출력
  python -u collect_data.py --apply
  python -u collect_data.py --apply --max-mb 20  # 큰 표까지
"""
import argparse, csv, glob, hashlib, os, shutil

HOME = os.path.expanduser("~")
CD = os.path.join(HOME, "projects/bk21-antibody-ml/consensus_docking")
