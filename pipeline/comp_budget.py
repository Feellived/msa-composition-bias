...
사용 (conda activate boltz · pipeline/ 에서):
  python -u comp_budget.py --all --out results/comp_budget.csv
  python -u comp_budget.py --targets "8ulr_HL 8k3k_D" --reps 200
"""
import argparse
import csv
import glob
...
def main():
    ...
    ap.add_argument("--merge-frac", type=float, default=0.75,
                    help="site_reproducibility.py 의 기본값과 맞춰 둔다(합집합 아님)")
