...
사용 (conda activate boltz · pipeline/ 에서):
  python -u analyze_cross_antibody.py --group RBD
  python -u analyze_cross_antibody.py --group all --out results/cross_antibody.csv
  python -u analyze_cross_antibody.py --targets "8q7s_C 8q7s_H 8q7s_O"     # 같은 PDB, 가장 깨끗
"""
import argparse
import csv
import glob
