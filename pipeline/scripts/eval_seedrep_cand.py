...
(run_seed_replicate.py 설계 그대로 — 개수 고정·조성만 흔들어 '개수 vs 조성' 판별.)

DockQ env(biopython + DockQ + scipy)에서:
  python eval_seedrep_cand.py
"""
import argparse, csv, glob, json, os, tempfile
import statistics as st
import lib_pose_features as PF   # 채점 로직 재사용(native_merged·pose_merged·dockq·pose_all_metrics·native_true·ES)
