...
사용 (conda activate boltz · pipeline/ 에서):
  python -u seed_vs_comp.py --selftest
  export DATA=/mnt/data/admuser/msadepth && python -u seed_vs_comp.py
  python -u seed_vs_comp.py --only "8k3k_D 8k46_I 8tp5_HL"
"""
