#!/usr/bin/env python3
"""[요약] site_reproducibility.py 결과를 타깃별 한 줄로 모아 세 질문에 답한다.
...
옛 판(정답으로 자세를 고른 것)과 새 판(AbEpiScore)을 나란히 놓으려면 두 폴더를 다 준다:
  python summarize_sites.py --dir results/honest
  python summarize_sites.py --dir results/honest --vs results       # 옛 판과 비교
"""
import argparse
import csv
import glob
